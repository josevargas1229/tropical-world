<?php
    class InventoryModel{
        ...
        public function updateProduct($productData){
            //paso1: creamos la consulta
            $sql="CALL productsx('".$productData['nombre']."','".$productData['descripcion']."',".$productData['id_porcion'].",".$productData['id_presentacion'].",".$productData['id'].",'".$productData['avatar']."','edit')";             
            //paso2: conectamos a la base de datos
            $connection=$this->dbconnection->getConnection();
            //paso3: ejecutamos la consulta
            $result=$connection->query($sql);
        ...
        public function insertProduct($productData){
            //paso1: creamos la consulta
            $sql="CALL productsx('".$productData['nombre']."','".$productData['descripcion']."',".$productData['id_porcion'].",".$productData['id_presentacion'].",' ','".$productData['avatar']."','add');";
            //paso2: conectamos a la base de datos
            $connection=$this->dbconnection->getConnection();
            //paso3: ejecutamos la consulta
            $result=$connection->query($sql);
